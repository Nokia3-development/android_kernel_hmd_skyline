...
// Modify by lina for QN7026A-171 on 20240418 begin
static void dwc3_override_vbus_status(struct dwc3_msm *mdwc, bool vbus_present);
// Modify by lina for QN7026A-171 on 20240418 end
		...
		unsigned long event, void *ptr)
{
	...
	// Modify by wenyaqi for QN7026A-11 on 20240116 begin
	#ifdef CONFIG_ARCH_TOMCAT
	struct dwc3 *dwc = NULL;
	const struct debugfs_reg32 *dwc3_regs = NULL;
	int size, i;
	#else
	...
	#endif
	// Modify by wenyaqi for QN7026A-11 on 20240116 end
